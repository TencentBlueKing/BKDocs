...
在配置平台中[新建业务](../快速入门/case1.md) 及业务拓扑。

## 步骤

1. CMDB 中创建服务实例，并注册进程和端口

2. 监控系统自动实现进程端口监控

### 1. CMDB 中创建服务实例，并注册进程和端口

当我们把主机从空闲机转移到业务模块下， 会提示是否要完善进程信息
...
等候一分钟，在蓝鲸自带的监控系统 [监控平台](../../../../Monitor/3.3/产品白皮书/intro/README.md) 中可以看到 [进程的运行情况](../../../../Monitor/3.3/产品白皮书/guide/process_monitor.md)。
