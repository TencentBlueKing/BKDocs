...
> **注意**：其实基于监控平台的插件定义可以非常方便的扩展监控能力，可以不用完全依赖官方的插件。具体查看
        * [制作 Script 插件(多种插件类型)](产品白皮书/integrations-metric-plugins/script_collect.md)
        * [制作 Exporter 插件(复用Prometheus插件)](产品白皮书/integrations-metric-plugins/import_exporter.md)
        * [制作 BK-Pull 插件(拉取Prometheus数据)](产品白皮书/integrations-metric-plugins/howto_bk-pull.md)
