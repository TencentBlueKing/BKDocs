...
| groupLabel | List&lt;[PipelineGroupLabels](batch-get-pipeline-layout-and-configuration.md)&gt; | 否 | 流水线分组和标签 |
...
| lock | boolean | 否 | 运行锁定 |
| model | [流水线模型-创建信息](batch-get-pipeline-layout-and-configuration.md) | 否 | 编排详情 |
