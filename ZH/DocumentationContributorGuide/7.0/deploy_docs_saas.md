...
- 文档内容包通常就是文档内容存放的地方，由各产品或在里面撰写文档，并由运营对文档内容包配置文件进行控制来渲染文档官网页面所展示的内容。仓库为
...
- 文档包,仓库为https://github.com/TencentBlueKing/support-docs/tree/prod-sg

- saas包,仓库为ttps://github.com/TencentBlueKing/blueking-docs
