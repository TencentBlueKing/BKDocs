...
- [主机在蓝鲸 CMDB 中管理](6.0/bk_solutions/CD/CMDB/CMDB_management_hosts.md)
...
更多详见 [术语定义](6.0/标准运维/术语解释/glossary.md)
...
[配置管理标准化](6.0/bk_solutions/CD/CMDB/Configuration_management_standardization.md)中提到，运维服务“四化建设”的标准化包含配置管理、发布、变更、故障处理、监控告警等场景的流程制定。以发布为例，通过流程图梳理应用交付的流程。
...
> 标准运维内置了 CMDB、作业平台、通知等标准组件，如果不在此列的，需要开发标准运维插件来 [集成企业内部 ITIL 系统](6.0/bk_solutions/CD/Automation/intergration_itil.md)。
