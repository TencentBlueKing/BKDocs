...
- 在配置平台中 [新建好业务](6.0/配置平台/快速入门/case1.md)。

- 熟悉一门脚本语言，如`Python`，本教程以`Python`为例

- 了解 [蓝鲸 CMDB API](6.0/API文档/CC/README.md)
...
- CMDB 同步脚本使用 [JOB](6.0/作业平台/产品功能/定时作业.md) 的定时作业或 [标准运维](6.0/标准运维/产品功能/flow.md) 的定时任务进行周期托管，方便迁移或者修改维护

![1562225679643](../assets/1562225679643.png)

注：上述教程是企业 CMDB `单向`、`定期`同步主机实例至蓝鲸 CMDB 的实践，如果需要实时同步，一般推荐 [消息推动](6.0/配置平台/产品功能/ModelManagement.md#事件推送)的方式。
