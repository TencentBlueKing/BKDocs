...
* [API 文档]()
    ...
    * [通过流程模板创建并开始执行任务](6.0/API文档/sops/zh-hans/create_and_start_task.md)
    ...
    * [获取职能化任务列表](6.0/API文档/sops/zh-hans/get_functionalization_task_list.md)
    ...
    * [根据插件 code 获取某个业务下对应插件信息](6.0/API文档/sops/zh-hans/get_plugin_detail.md)
    ...
    * [获取一批任务的是否需要人工干预的判断状态](6.0/API文档/sops/zh-hans/get_tasks_manual_intervention_state.md)
    ...
    * [获取节点选择后新的任务树（针对公共流程）](6.0/API文档/sops/zh-hans/preview_common_task_tree.md)
