...
|--|--|--|
| 流程服务（bk_itsm） | 2.8.0 | https://bkopen-1252002024.file.myqcloud.com/saas-paas3/bk_itsm/bk_itsm-V2.8.0.tar.gz |
| 标准运维（bk_sops） | 3.34.16.2202 | https://bkopen-1252002024.file.myqcloud.com/saas-paas3/bk_sops/bk_sops-V3.34.16.2202.tar.gz |
...
| KEY | 建议取值 | 描述 | 取值说明 |
| -- | -- | -- | -- |
| C_FORCE_ROOT | 1 | 用于启动celery worker | 固定取值 |
| ENABLE_SYNC_API_GATEWAY | 1 | 是否同步网关资源 | 固定取值 |
