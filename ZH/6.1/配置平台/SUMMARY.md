...
* [产品白皮书]()
    ...
    * [API 文档]()
        ...
        * [根据主机列表信息添加主机到指定 id 的资源池](6.1/API文档/cc/zh-hans/add_host_to_resource_pool.md)
        ...
        * [批量创建通用模型实例关联关系](6.1/API文档/cc/zh-hans/batch_create_instance_association.md)
        * [批量创建通用模型实例](6.1/API文档/cc/zh-hans/batch_create_inst.md)
        ...
        * [模型实例关系数量查询](6.1/API文档/cc/zh-hans/count_instance_associations.md)
        * [通用模型实例数量查询](6.1/API文档/cc/zh-hans/count_object_instances.md)
        ...
        * [删除服务模板](6.1/API文档/cc/zh-hans/delete_service_template.md)
        ...
        * [查询实例其直接相关联的上、下层级(模型)的简明关系信息](6.1/API文档/cc/zh-hans/find_brief_biz_topo_node_relation.md)
        ...
        * [根据业务拓扑实例节点，查询该实例节点下的主机关系信息](6.1/API文档/cc/zh-hans/find_host_relations_with_topo.md)
        ...
        * [查询模型实例关联关系，可选择返回源模型实例与目标模型实例的详情](6.1/API文档/cc/zh-hans/find_instassociation_with_inst.md)
        ...
        * [通用模型实例关系查询](6.1/API文档/cc/zh-hans/search_instance_associations.md)
        ...
        * [通用模型实例查询](6.1/API文档/cc/zh-hans/search_object_instances.md)
        ...
        * [集群模板同步](6.1/API文档/cc/zh-hans/sync_set_template_to_set.md)
        * [业务内主机转移模块](6.1/API文档/cc/zh-hans/transfer_host_module.md)
        * [上交主机到业务的故障机模块](6.1/API文档/cc/zh-hans/transfer_host_to_faultmodule.md)
        * [上交主机到业务的待回收模块](6.1/API文档/cc/zh-hans/transfer_host_to_recyclemodule.md)
