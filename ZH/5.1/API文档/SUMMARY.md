...
* [配置平台]()
    ...
    * [添加自定义 API](CC/create_custom_query.md)
    ...
    * [删除自定义 API](CC/delete_custom_query.md)
    ...
    * [根据自定义 api 获取数据](CC/get_custom_query_data.md)
    * [获取自定义 API 详情](CC/get_custom_query_detail.md)
    ...
    * [查询自定义 API](CC/search_custom_query.md)
    ...
    * [更新自定义 API](CC/update_custom_query.md)
