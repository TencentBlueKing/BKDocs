...
![-w2020](../../assets/326ababcfc69fdc10cabfd39796676a7.png)
...
![-w2020](../../assets/a55041cc4b3ab7976c34e358ac8b3b41.png)

信息导入后传至前端表格，造成场景 1 中的标签内 XSS

又比如，文件上传并展示

![-w2020](../../assets/e08be04c348f9250c3d24c679a617f89.png)
...
![-w2020](../../assets/87edf0c87e3db5cf3097615c54809f5e.png)
...
![-w2020](../../assets/ebbe6350da894c8e42735fb17611553f.png)
...
![-w2020](../../assets/72511672873780806cc69d64b8b0eb65.png)
...
### 场景 2 ：对 post 请求中的预置参数更改进行越权

一些固定的 post 参数，如 hidden 属性的 input，或 ajax 的 data 中在页面返回时就确定的信息，都是可能被修改的

![-w2020](../../assets/615861de178d2a0ab7587fb96a28a9eb.png)
