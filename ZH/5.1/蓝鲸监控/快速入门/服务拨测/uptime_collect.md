...
![-w2020](../../assets/15301111715232.jpg)
...
默认新建的拨测协议为 HTTP(S) ，即 HTTP 或 HTTPS 协议。
  ...
  - GET 方法
    ...
    ![-w2020](../../assets/15299999202180.jpg)

  - POST 方法

    - 与 GET 方法相比多一项`提交内容`：输入需要提交的请求内容

    ![-w2020](../../assets/15300147159505.jpg)
...
>> POST 请求可提前通过作业平台在拨测节点本地测试，测试成功后再通过蓝鲸监控进行服务拨测
  ...
  - 高级设置
    ...
    - 头信息：请求的头信息，比如 `Cookies` 。
      ...
      ![-w2020](../../assets/15301109148955.jpg)

### TCP 协议

  - 从拨测节点探测 TCP 服务的可用性。

    ![-w2020](../../assets/15301099924864.jpg)
...
### UDP 拨测
  ...
  - 从拨测节点探测 UDP 服务的可用性
    ...
    ![-w2020](../../assets/15301105986305.jpg)
