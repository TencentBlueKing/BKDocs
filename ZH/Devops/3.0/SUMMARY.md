...
* [产品功能]()
    ...
    * [流水线]()
        ...
        * [编排流水线]()
            ...
            * [多个 Job 使用集群中的同一台机器进行构建](UserGuide/Services/Pipeline/pipeline-edit-guide/multiple-jobs-one-machine.md)
            * [并发控制]()
                * [控制流水线并发](UserGuide/Services/Pipeline/pipeline-edit-guide/concurrency-control/pipeline-concurrency.md)
                * [Job 并发控制](UserGuide/Services/Pipeline/pipeline-edit-guide/concurrency-control/job-concurrency.md)
    ...
    * [Pipeline as Code - 开发中]()
        * [快速上手]()
            ...
            * [触发时 YAML 配置取值规则](UserGuide/Services/Pipeline-as-Code/01-quick-start/04-yml-spec.md)
        ...
        * [编排流水线]()
            * [添加触发器]()
                * [监听 YAML 所在库的事件](UserGuide/Services/Pipeline-as-Code/02-generate-pipelines/01-triggers/01-add-trigger.md)
                * [监听非 YAML 所在库的事件](UserGuide/Services/Pipeline-as-Code/02-generate-pipelines/01-triggers/02-cros-git.md)
            ...
            * [添加 Job]()
                ...
                * [设置 Job 依赖](UserGuide/Services/Pipeline-as-Code/02-generate-pipelines/03-jobs/06-job-depend-on.md)
                * [设置节点复用](UserGuide/Services/Pipeline-as-Code/02-generate-pipelines/03-jobs/07-lock-resource-with.md)
            * [添加 Step]()
            ...
            * [定义和使用变量]()
                * [定义变量](UserGuide/Services/Pipeline-as-Code/02-generate-pipelines/05-variables/01-variables.md)
                * [设置 Job/Step 环境变量](UserGuide/Services/Pipeline-as-Code/02-generate-pipelines/05-variables/02-job.md)
                * [引用凭据](UserGuide/Services/Pipeline-as-Code/02-generate-pipelines/05-variables/03-settings.md)
                * [引用插件输出变量](UserGuide/Services/Pipeline-as-Code/02-generate-pipelines/05-variables/04-Quote.md)
            ...
            * [并发控制]()
                * [设置流水线并发](UserGuide/Services/Pipeline-as-Code/02-generate-pipelines/10-concurrent/01-concurrent-pipeline.md)
                * [设置 Job 并发控制](UserGuide/Services/Pipeline-as-Code/02-generate-pipelines/10-concurrent/02-concurrent-job.md)
    * [环境]()
        * [私有构建资源]()
