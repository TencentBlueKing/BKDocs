...
bkmonitorbeat | 3.22.x | [bkmonitorbeat-3.22.1354.tgz](https://bkopen-1252002024.file.myqcloud.com/gse_plugins/bkmonitorbeat-3.22.1354.tgz) | &nbsp;
...
- `bkmonitorbeat-3.22.1354.tgz`

  【Fixed】修复 windows CPU 核心数获取不准确问题

  【Updated】更新 gopsutils 版本 兼容网卡数据输出格式
