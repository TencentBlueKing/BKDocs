...
* [快速开始](.)
    ...
    * [开发 Golang 应用](quickstart/go/golang_preparations.md)
    * [蓝鲸应用开发交付规范](quickstart/app_delivery_guidelines.md)
    * [蓝鲸应用构建指引](quickstart/app_build_guidelines.md)
* [开发指南](.)
...
* [常用功能](.)
    ...
    * [敏感环境变量加密](topics/paas/sensitive_env_encryption.md)
    ...
    * [Metric 上报指引](topics/paas/monitoring/metrics.md)
* [基础概念](.)
