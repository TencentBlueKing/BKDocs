...
BKFara 分析处置平台是蓝鲸体系下的智能故障诊断平台，面向运维和开发团队，以A2A的形式动态编排智能体，提供从告警接入、智能分析、根因定位到处置执行的一站式故障闭环能力。
...
- 统一入口：汇聚告警、事件、巡检等多源信号，自动降噪聚合，统一进入故障分析流程

- 智能诊断：主智能体自动编排已知/未知双通道，调度拓扑分析、异常检测、日志关联等专项子智能体协同排障

- 知识沉淀：从每次排障过程中自动抽取经验，持续积累故障知识库，孵化排障 Skill，形成可进化的排障能力飞轮

- 可审计处置：处置流程支持审核、审计、通知，全链路可追溯
