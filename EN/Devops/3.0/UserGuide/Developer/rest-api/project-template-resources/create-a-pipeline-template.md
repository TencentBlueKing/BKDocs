 ...
 | :--- | :--- | :--- | :--- | :--- | 
 | body |[Pipeline model-create Info](create-a-pipeline-template.md)| Yes| template|| 
 ...
 | :--- | :--- | :--- | 
 | 200 | successful operation |[data Return Packaging model TemplateId](create-a-pipeline-template.md)| 
...
```
 ...
 | stages |List&lt; [Pipeline model](create-a-pipeline-template.md)&gt;|Yes| Stage Collection| 
 ...
 | checkIn | [StagePauseCheck](create-a-pipeline-template.md) |No| Can the current Stage be retry| 
 ...
 | containers |List&lt; [Pipeline model base class](create-a-pipeline-template.md)&gt;|Yes| container Collection| 
 | id | string |No| Stage ID| 
 | stageControlOption | [StageControlOption](create-a-pipeline-template.md) |Yes| jobOption| 
 | checkOut | [StagePauseCheck](create-a-pipeline-template.md) |No| Can the current Stage be retry| 
 ...
 | reviewParams |List&lt; [Manual toCheck-stageReviewParams](create-a-pipeline-template.md)&gt;|No|  reviewParams | 
 | manualTrigger | boolean |No|  manualTrigger | 
 | checkTimes | integer |No|  checkTimes | 
 | reviewDesc | string |No|  reviewDesc | 
 | reviewGroups |List&lt; [Stage toCheck group information](create-a-pipeline-template.md)&gt;|No|  reviewGroups | 
 ...
 | options |List&lt; [Manual toCheck-stageReviewParams-Drop-down Box List](create-a-pipeline-template.md)&gt;|No| Drop-down box list| 
 ...
 | params |List&lt; [Manual toCheck-stageReviewParams](create-a-pipeline-template.md)&gt;|No| toCheck Incoming var| 
 ...
 | elements |List&lt; [Element](create-a-pipeline-template.md)&gt;|No|  elements | 
 | name | string |No|  name | 
 | id | string |No|  id | 
 ...
 | elementPostInfo |[element post information](create-a-pipeline-template.md)| No|  elementPostInfo | 
 ...
 ## Data Return Package model TemplateId 
