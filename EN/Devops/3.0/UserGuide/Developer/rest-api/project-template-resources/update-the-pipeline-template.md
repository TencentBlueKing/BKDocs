 ...
 | variableName| Type| Must| Parameter Description| defaultValue| 
 | :--- | :--- | :--- | :--- | :--- | 
 | body |[Pipeline model-create Info](update-the-pipeline-template.md)| Yes| template|| 
 ...
 ```javascript 
 curl -X PUT '[Replace with API Address bar Request Url]?  versionName={versionName}' \ 
 -H 'X-DEVOPS-UID:xxx' 
 ``` 
 ...
 | stages |List&lt; [Pipeline model](update-the-pipeline-template.md)&gt;|Yes| Stage Collection| 
 ...
 | checkIn | [StagePauseCheck](update-the-pipeline-template.md) |No| Can the current Stage be retry| 
 ...
 | containers |List&lt; [Pipeline model base class](update-the-pipeline-template.md)&gt;|Yes| container Collection| 
 | id | string |No| Stage ID| 
 | stageControlOption | [StageControlOption](update-the-pipeline-template.md) |Yes| jobOption| 
 | checkOut | [StagePauseCheck](update-the-pipeline-template.md) |No| Can the current Stage be retry| 
 ...
 | reviewParams |List&lt; [Manual toCheck-stageReviewParams](update-the-pipeline-template.md)&gt;|No|  reviewParams | 
 | manualTrigger | boolean |No|  manualTrigger | 
 | checkTimes | integer |No|  checkTimes | 
 | reviewDesc | string |No|  reviewDesc | 
 | reviewGroups |List&lt; [Stage toCheck group information](update-the-pipeline-template.md)&gt;|No|  reviewGroups | 
 ...
 | options |List&lt; [Manual toCheck-stageReviewParams-Dropdown Box List](update-the-pipeline-template.md)&gt;|No| Drop-down box list| 
 ...
 | params |List&lt; [Manual toCheck-stageReviewParams](update-the-pipeline-template.md)&gt;|No| toCheck Incoming var| 
 ...
 | elements |List&lt; [Element](update-the-pipeline-template.md)&gt;|No|  elements | 
 | name | string |No|  name | 
 | id | string |No|  id | 
 ...
 | elementPostInfo |[element post info](update-the-pipeline-template.md)| No|  elementPostInfo | 
