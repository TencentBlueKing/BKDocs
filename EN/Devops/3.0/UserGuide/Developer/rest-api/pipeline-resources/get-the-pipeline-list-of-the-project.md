 # Get the Pipeline list of the project 
 ...
 | checkPermission | boolean |No| Check auth|| 
 ...
 | :--- | :--- | :--- | 
 | 200 | successful operation |[data Return Wrapper model Paging Data Wrapper Model Pipeline Model-List Information](get-the-pipeline-list-of-the-project.md)| 

 #### Request Sample 

 ```javascript 
 curl -X GET '[Replace with API Address bar Request Url]?  page={page}&amp;pageSize={pageSize}&amp;checkPermission={checkPermission}&amp;channelCode={channelCode}' \ 
 -H 'X-DEVOPS-UID:xxx' 
 ``` 
...
```
 ...
 ## Data Return Packaging model Paging Data Packaging Model Pipeline Model-List Information 

 | variableName| Type| Must| Parameter Description| 
 | :--- | :--- | :--- | :--- | 
 | data |[Paged data Wrapping model Pipeline Model-List Information](get-the-pipeline-list-of-the-project.md)| No| data| 
 | message | string |No| Error Message| 
 | status | integer |Yes| Status Code| 

 ## Paged data Packaging model Pipeline Model-List Information 

 | variableName| Type| Must| Parameter Description| 
 | :--- | :--- | :--- | :--- | 
 | records |List&lt; [Pipeline model info](get-the-pipeline-list-of-the-project.md)&gt;|Yes| data| 
 ...
 | groupLabel |List&lt; [PipelineGroupLabels](get-the-pipeline-list-of-the-project.md)&gt;|No| Pipeline group and label| 
 ...
 | model |[Pipeline model-create Information](get-the-pipeline-list-of-the-project.md)| No| Arrangement detail| 
 ...
 | stages |List&lt; [Pipeline model](get-the-pipeline-list-of-the-project.md)&gt;|Yes| Stage Collection| 
 ...
 | checkIn | [StagePauseCheck](get-the-pipeline-list-of-the-project.md) |No| Can the current Stage be retry| 
 ...
 | containers |List&lt; [Pipeline model base class](get-the-pipeline-list-of-the-project.md)&gt;|Yes| container Collection| 
 | id | string |No| Stage ID| 
 | stageControlOption | [StageControlOption](get-the-pipeline-list-of-the-project.md) |Yes| jobOption| 
 | checkOut | [StagePauseCheck](get-the-pipeline-list-of-the-project.md) |No| Can the current Stage be retry| 
 ...
 | reviewParams |List&lt; [Manual toCheck-stageReviewParams](get-the-pipeline-list-of-the-project.md)&gt;|No|  reviewParams | 
 | manualTrigger | boolean |No|  manualTrigger | 
 | checkTimes | integer |No|  checkTimes | 
 | reviewDesc | string |No|  reviewDesc | 
 | reviewGroups |List&lt; [Stage toCheck Group Information](get-the-pipeline-list-of-the-project.md)&gt;|No|  reviewGroups | 
 ...
 | options |List&lt; [Manual toCheck-stageReviewParams-Drop-down Box List](get-the-pipeline-list-of-the-project.md)&gt;|No| Drop-down box list| 
 ...
 | params |List&lt; [Manual toCheck-stageReviewParams](get-the-pipeline-list-of-the-project.md)&gt;|No| toCheck Incoming var| 
 ...
 | elements |List&lt; [Element](get-the-pipeline-list-of-the-project.md)&gt;|No|  elements | 
 | name | string |No|  name | 
 | id | string |No|  id | 
 ...
 | elementPostInfo |[element post info](get-the-pipeline-list-of-the-project.md)| No|  elementPostInfo | 
