...
* [开发者资料库]()
    * [REST API]()
        ...
        * [OPENAPI-构建资源]()
            ...
            * [获取签后IPA文件下载路径](产品白皮书/Developer/rest-api/build-resources/get-the-download-path-of-the-signed-ipa-file.md)
        ...
        * [OPENAPI-callback资源]()
            ...
            * [批量创建callback回调](产品白皮书/Developer/rest-api/callback-resource/create-callbacks-in-batches.md)
