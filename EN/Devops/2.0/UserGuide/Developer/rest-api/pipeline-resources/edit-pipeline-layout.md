 ...
 | variableName| Type| Must| Parameter Description| defaultValue| 
 | :--- | :--- | :--- | :--- | :--- | 
 | body |[Pipeline model-create Information](edit-pipeline-layout.md)| Yes| Pipeline model|| 
 ...
 | :--- | :--- | :--- | 
 | 200 | successful operation |[data Return Packaging model Boolean](edit-pipeline-layout.md)| 
 ...
 | stages |List&lt; [Pipeline model](edit-pipeline-layout.md)&gt;|Yes| Stage Collection| 
 ...
 | checkIn | [StagePauseCheck](edit-pipeline-layout.md) |No| Can the current Stage be retry| 
 ...
 | containers |List&lt; [Pipeline model base class](edit-pipeline-layout.md)&gt;|Yes| container Collection| 
 | id | string |No| Stage ID| 
 | stageControlOption | [StageControlOption](edit-pipeline-layout.md) |Yes| jobOption| 
 | checkOut | [StagePauseCheck](edit-pipeline-layout.md) |No| Can the current Stage be retry| 
 ...
 | reviewParams |List&lt; [Manual toCheck-stageReviewParams](edit-pipeline-layout.md)&gt;|No|  reviewParams | 
 | manualTrigger | boolean |No|  manualTrigger | 
 | checkTimes | integer |No|  checkTimes | 
 | reviewDesc | string |No|  reviewDesc | 
 | reviewGroups |List&lt; [Stage toCheck group information](edit-pipeline-layout.md)&gt;|No|  reviewGroups | 
 ...
 | options |List&lt; [Manual toCheck-stageReviewParams-Drop-down Box List](edit-pipeline-layout.md)&gt;|No| Drop-down box list| 
 ...
 | params |List&lt; [Manual toCheck-stageReviewParams](edit-pipeline-layout.md)&gt;|No| toCheck Incoming var| 
 ...
 | elements |List&lt; [Element](edit-pipeline-layout.md)&gt;|No|  elements | 
 | name | string |No|  name | 
 | id | string |No|  id | 
 ...
 | elementPostInfo |[element post information](edit-pipeline-layout.md)| No|  elementPostInfo | 
