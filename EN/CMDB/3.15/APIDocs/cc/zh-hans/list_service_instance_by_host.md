...
/api/c/compapi/v2/cc/list_service_instance_by_host/
...
Get the list of service instances bound to the host according to the host id
...
| bk_host_id | int | yes | host ID | get service instance information bound to the host |
