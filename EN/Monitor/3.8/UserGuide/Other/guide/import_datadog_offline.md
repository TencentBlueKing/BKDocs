...
5. Improve config.json`info/config.json` defines parameters based on the placeholders reserved by the template in step 2. The format refers to the plug-in specification. An example is as follows, where:
